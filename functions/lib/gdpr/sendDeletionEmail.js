...
exports.sendDeletionEmail = void 0;
const auth_1 = require("firebase-admin/auth");
/**
 * Envoie un email de notification de suppression de compte avec lien de rétractation (30 jours).
 */
async function sendDeletionEmail(uid, db) {
    try {
        const authUser = await (0, auth_1.getAuth)().getUser(uid).catch(() => null);
...
//# sourceMappingURL=sendDeletionEmail.js.map